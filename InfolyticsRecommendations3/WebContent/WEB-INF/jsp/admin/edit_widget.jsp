...
<br clear="all" />
<div id="clearGistWidget" style="font-family:Arial, Helvetica, sans-serif; width:800px; border: 1px solid #000000;overflow: hidden;">
<div id="clearGistWidgetHeader" style="color:#333333;font-size:14px;font-weight:bold;text-align:center;background-color:#ffffff;height:100%;padding-top:10px;padding-bottom:10px;">
...
<div id="clearGistWidgetFooter" style="color:#666666;font-size:10px;text-align:center;background-color:#ffffff;width:800px;padding-top:5px;padding-bottom:10px;">
		powered by <br /><a href="http://www.cleargist.com" target="_blank"><img src="../images/logo_small.png" border="0"/></a>
		</div>
	</div>
</div>
				</div>
		...
		<div id="previewAreaHidden" style="display: none;">
			<div id="CGW"
				style="font-family: Arial, Helvetica, sans-serif; width: 800px; border: 1px solid #000000; overflow: hidden;">
				<div id="CGWHeader"
				...
				<div id="CGWFooter"
					...
					<a href="http://www.cleargist.com" target="_blank"><img
						src="../images/logo_small.png" border="0" /></a>
				</div>
			</div>
		</div>
		<!--hidden code ends-->
