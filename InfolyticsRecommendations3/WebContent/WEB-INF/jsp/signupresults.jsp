...
<body>
	...
	<div class="container" align="center">
		<div class="main" align="left">
			...
			<div id="promo">
				<h2 class="title">
					You have successfully signed up to our services! To activate your account, please follow the link sent to your email account. Thank you for using our services. 
				</h2>
				<div class="content">
					<div class="quote">
						<p>
