...
import com.cleargist.recommendations.util.Profile;
...
//   	dao.saveTenant(t);
 ...
 //   	dao.deleteTenantByID("TEST");
    ...
    public void addNewUser() {
		...
		Assert.assertTrue(referenceProfile.equals(profile));
	}
	...
	public void addAttributes() {
		...
		Assert.assertTrue(profile.getAttributes().size() == 2);
		...
		Assert.assertTrue(updatedProfile.getAttributes().size() == 3);
	}
