...
public class DescriptionCategoryTextClassifier extends TextClassifier {
	...
	public HashMap<String, List<String>> getData(File dealsFile, File annotatedFile) {
		...
		for (DealType annotatedDeal : annotatedDeals) {
			...
			String terms = scrapedDeal.getTerms();
			String merchantDescription = scrapedDeal.getMerchantDescription();
			
			String text = title + " " + terms + " " + merchantDescription;
