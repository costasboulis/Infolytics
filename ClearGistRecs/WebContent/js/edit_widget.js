...
function editWidget(obj) {
	...
	if (bValid) {
		...
		var params = "tenantId="+tenantId+"&id="+$("#hiddenWidgetId").val()+"&name="+encodeURIComponent($("#name").val())+"&description="+$("#description").val()+"&selLayoutType="+$("#selLayoutType").val()+"&selNoOfItems="+$("#selNoOfItems").val()+
		...
		"&sName="+sName+"&sPrice="+sPrice+"&sCat="+sCat+"&selListWidth="+$("#selListWidth").val()+"&selListSpaces="+$("#selListSpaces").val()+"&selListSpaces2="+$("#selListSpaces2").val()+
