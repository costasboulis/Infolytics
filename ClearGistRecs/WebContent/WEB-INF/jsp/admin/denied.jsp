...
<body>
        ...
        <div class="wrapper">    
            <div class="header-wrapper">
                <div class="container">
                    <div id="header">
                        <div id="divLogo"><a href="/"><img src="../images/logo_admin.png" border="0" /></a></div>           
                        <div id="divInfo">
                            <div class="content">
                        ...
                        <div id="divRightMenu">
                            <ul class="rightMenu">
                                ...
                                <li><a href="http://www.cleargist.com/contact.php">Contact</a></li>
                                <li><a href="http://www.cleargist.com/">About</a></li>
                            </ul>
                        </div>
                        </div>
            ...
            <!--main-->  
            <form name="frmSignIn" id="frmSignIn" action="j_spring_security_check">
            <div class="main-wrapper">
                <div class="container">
                    ...
                    <div id="loginBox">
                        <div class="content">
                                Access Denied! Only admins can see this page!
                            </div>
                    </div>
                </div>
            </div>
